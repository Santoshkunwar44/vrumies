...
const CreatePost = () => {
    ...
    useEffect(() => {
        if (data) {
            const filterd = data.filter(cat=>cat.type==="post");
                        ...
                        <div className={styles.createPostTopRight} >
                            <div className={styles.topRightWrapper}>
                                ...
                                <div className={styles.postToprightInfosBox}>
                                    <p>
                                        <span className={styles.key}>  Category selected </span>  : {currentSelectedCategory?.name }
                                    </p>
                                    <p>
                                        ...
                                        <div className={styles.contentRightTop}>
                                            ...
                                            <div className={styles.createPostRightInputsBox}>
                                                <div className={styles.createPostRightInputsItem}>
                                                    ...
                                                    <select onChange={onChangeInput } value={currentSelectedCategory} className={styles.createPostSelect} name={"category"} >
